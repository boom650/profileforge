...
class _$UserProfileImpl implements _UserProfile {
  ...
  @override
  String toString() {
    return 'UserProfile(id: $id, name: $name, email: $email, phone: $phone, board: $board, stream: $stream, grade: $grade, subjects: $subjects, tenthPercentage: $tenthPercentage, coachingInstitute: $coachingInstitute, coachingHoursPerWeek: $coachingHoursPerWeek, satScore: $satScore, ieltsScore: $ieltsScore, targetCountries: $targetCountries, targetMajor: $targetMajor, reachUniversities: $reachUniversities, matchUniversities: $matchUniversities, safetyUniversities: $safetyUniversities, activities: $activities, schedule: $schedule, motivation: $motivation, createdAt: $createdAt, updatedAt: $updatedAt, interests: $interests, skills: $skills, preferredLocations: $preferredLocations, latitude: $latitude, longitude: $longitude, city: $city, state: $state, pincode: $pincode, preferences: $preferences)';
  }
...
abstract class _UserProfile implements UserProfile {
  const factory _UserProfile(
      ...
      required final Map<String, dynamic> preferences}) = _$UserProfileImpl;
