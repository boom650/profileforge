...
class _TimeRow extends StatelessWidget {
  ...
  Color _getBlockColor(String type) {
    switch (type) {
      ...
      case 'coaching': return const Color(0xFF8B5CF6).withValues(alpha: 0.3);
      ...
      case 'study': return const Color(0xFF10B981).withValues(alpha: 0.3);
      case 'free': return const Color(0xFF10B981).withValues(alpha: 0.15);
