...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      GoRoute(
        path: '/home',
        builder: (c, s) => HomePage(profileId: pid),
      ),
      GoRoute(
        path: '/missions',
        builder: (c, s) => MissionsScreen(profileId: pid),
      ),
      GoRoute(
        path: '/leagues',
        builder: (c, s) => LeaguesScreen(profileId: pid),
      ),
      GoRoute(
        path: '/buddies',
        builder: (c, s) => BuddiesScreen(profileId: pid),
      ),
      GoRoute(
        path: '/skins',
        builder: (c, s) => SkinsScreen(profileId: pid),
      ),
      GoRoute(
        path: '/teams',
        builder: (c, s) => TeamsScreen(profileId: pid),
      ),
      GoRoute(
        path: '/discover',
        builder: (c, s) => DiscoverScreen(profileId: pid),
      ),
      GoRoute(
        path: '/rewards',
        builder: (c, s) => RewardsScreen(profileId: pid),
      ),
      GoRoute(
        path: '/profile',
        builder: (c, s) => ProfileScreen(profileId: pid),
      ),
      GoRoute(
        path: '/onboarding',
        builder: (c, s) => OnboardingScreen(profileId: pid),
      ),
    ],
  );
});
